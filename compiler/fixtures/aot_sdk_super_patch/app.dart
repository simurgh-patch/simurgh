...
int chain() {
  ...
  final first = Node(4);
  list.add(first);
  first.insertAfter(Node(5));
  return list.fold<int>(0, (sum, node) => sum + node.value);
}
...
class FreshMap extends MapBase<String, int> {
  final Map<String, int> data = {'a': 4, 'b': 5};
...
class AddedError extends Error {}
