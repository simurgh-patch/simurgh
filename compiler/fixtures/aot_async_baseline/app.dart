...
Future<void> fail() async {
  await stable(0);
  throw StateError('baseline async');
}
...
Future<int> arrow(int value) async => (await stable(value)) + 20;
Future<int> passthrough(Future<int> value) => value;
Future<num> widened() async { await stable(0); return 1; }
